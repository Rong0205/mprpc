...
PROTOBUF_CONSTEXPR LoginResponse::LoginResponse(
  ...
  , /*decltype(_impl_.last_login_time_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static ::_pb::Metadata file_level_metadata_test2_2eproto[2];
...
const uint32_t TableStruct_test2_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.error_code_),
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.errmsg_),
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.last_login_time_),
};
...
const char descriptor_table_protodef_test2_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\004name\030\001 \001(\t\022\013\n\003pwd\030\002 \001(\t\"L\n\rLoginRespons"
  "e\022\022\n\nerror_code\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\t\022\027\n"
  "\017last_login_time\030\003 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_test2_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_test2_2eproto = {
    false, false, 150, descriptor_table_protodef_test2_2eproto,
    "test2.proto",
    &descriptor_table_test2_2eproto_once, nullptr, 0, 2,
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  _impl_.last_login_time_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.last_login_time_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_last_login_time().empty()) {
    _this->_impl_.last_login_time_.Set(from._internal_last_login_time(), 
      _this->GetArenaForAllocation());
  }
...
inline void LoginResponse::SharedDtor() {
  ...
  _impl_.last_login_time_.Destroy();
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          auto str = _internal_mutable_last_login_time();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "fixbug.LoginResponse.last_login_time"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* LoginResponse::_InternalSerialize(
  ...
  // string last_login_time = 3;
  if (!this->_internal_last_login_time().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_last_login_time().data(), static_cast<int>(this->_internal_last_login_time().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "fixbug.LoginResponse.last_login_time");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_last_login_time(), target);
  }
...
void LoginResponse::InternalSwap(LoginResponse* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.last_login_time_, lhs_arena,
      &other->_impl_.last_login_time_, rhs_arena
  );
