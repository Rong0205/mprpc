...
class LoginResponse final :
 ...
 public:
  ...
  // string last_login_time = 3;
  void clear_last_login_time();
  const std::string& last_login_time() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_last_login_time(ArgT0&& arg0, ArgT... args);
  std::string* mutable_last_login_time();
  PROTOBUF_NODISCARD std::string* release_last_login_time();
  void set_allocated_last_login_time(std::string* last_login_time);
  private:
  const std::string& _internal_last_login_time() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_last_login_time(const std::string& value);
  std::string* _internal_mutable_last_login_time();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr last_login_time_;
    int32_t error_code_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
inline int32_t LoginResponse::error_code() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.error_code)
...
inline void LoginResponse::set_error_code(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.error_code)
}
...
// string last_login_time = 3;
inline void LoginResponse::clear_last_login_time() {
  _impl_.last_login_time_.ClearToEmpty();
}
inline const std::string& LoginResponse::last_login_time() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.last_login_time)
  return _internal_last_login_time();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginResponse::set_last_login_time(ArgT0&& arg0, ArgT... args) {
 
 _impl_.last_login_time_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginResponse.last_login_time)
}
inline std::string* LoginResponse::mutable_last_login_time() {
  std::string* _s = _internal_mutable_last_login_time();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.last_login_time)
  return _s;
}
inline const std::string& LoginResponse::_internal_last_login_time() const {
  return _impl_.last_login_time_.Get();
}
inline void LoginResponse::_internal_set_last_login_time(const std::string& value) {
  
  _impl_.last_login_time_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginResponse::_internal_mutable_last_login_time() {
  
  return _impl_.last_login_time_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginResponse::release_last_login_time() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.last_login_time)
  return _impl_.last_login_time_.Release();
}
inline void LoginResponse::set_allocated_last_login_time(std::string* last_login_time) {
  if (last_login_time != nullptr) {
    
  } else {
    
  }
  _impl_.last_login_time_.SetAllocated(last_login_time, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.last_login_time_.IsDefault()) {
    _impl_.last_login_time_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.last_login_time)
}
